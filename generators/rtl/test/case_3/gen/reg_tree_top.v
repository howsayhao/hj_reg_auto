...
(
	...
	,input [1-1:0]REG1_ONREAD_NA__FIELD_0__pulse
	,input [32-1:0]REG2_ONREAD_RCLR__FIELD_0__next_value
	,input [1-1:0]REG2_ONREAD_RCLR__FIELD_0__pulse
	,input [32-1:0]REG3_ONREAD_RSET__FIELD_0__next_value
	,input [1-1:0]REG3_ONREAD_RSET__FIELD_0__pulse
...
regslv_reg_top__reg_block_1 #(.ADDR_WIDTH(`ADDR_WIDTH), .DATA_WIDTH(`DATA_WIDTH))
	...
	,.REG1_ONREAD_NA__FIELD_0__next_value(REG1_ONREAD_NA__FIELD_0__next_value),.REG1_ONREAD_NA__FIELD_0__pulse(REG1_ONREAD_NA__FIELD_0__pulse),.REG2_ONREAD_RCLR__FIELD_0__next_value(REG2_ONREAD_RCLR__FIELD_0__next_value)
	,.REG2_ONREAD_RCLR__FIELD_0__pulse(REG2_ONREAD_RCLR__FIELD_0__pulse),.REG3_ONREAD_RSET__FIELD_0__next_value(REG3_ONREAD_RSET__FIELD_0__next_value),.REG3_ONREAD_RSET__FIELD_0__pulse(REG3_ONREAD_RSET__FIELD_0__pulse)
	,.REG1_ONREAD_NA__FIELD_0__curr_value(REG1_ONREAD_NA__FIELD_0__curr_value),.REG2_ONREAD_RCLR__FIELD_0__curr_value(REG2_ONREAD_RCLR__FIELD_0__curr_value),.REG3_ONREAD_RSET__FIELD_0__curr_value(REG3_ONREAD_RSET__FIELD_0__curr_value)
