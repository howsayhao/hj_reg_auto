...
//***************************************WIRE DECLARATION START***************************************//
	...
	logic REG1_ONREAD_NA_wr_en;
	logic REG1_ONREAD_NA_rd_en;
	logic [31:0] REG2_ONREAD_RCLR_wr_data;
	logic REG2_ONREAD_RCLR_wr_en;
	logic REG2_ONREAD_RCLR_rd_en;
	logic [31:0] REG3_ONREAD_RSET_wr_data;
	logic REG3_ONREAD_RSET_wr_en;
	logic REG3_ONREAD_RSET_rd_en;
...
//***************************************ADDRESS DECODER START****************************************//
	...
	always_comb begin
		...
		unique casez (global_address)
			64'h0,64'h4,64'h8:int_selected = 1'b1;//
...
//**************************************REG/FIELD INSTANCE START**************************************//
	...
	logic [31:0] REG1_ONREAD_NA_o;
	assign REG1_ONREAD_NA_wr_data = wr_sel[0] ? regfile_wr_data : 0;
	assign REG1_ONREAD_NA_wr_en = wr_sel[0];
	assign REG1_ONREAD_NA_rd_en = rd_sel[0];
	field
	...
	x__REG1_ONREAD_NA__FIELD_0
		...
		.sw_rd                 (REG1_ONREAD_NA_rd_en),
		.sw_wr                 (REG1_ONREAD_NA_wr_en),
	...
	always_comb begin
	REG1_ONREAD_NA_o[31:0] = 32'h0;
		REG1_ONREAD_NA_o[31:0] = REG1_ONREAD_NA__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[0] = REG1_ONREAD_NA_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG2_ONREAD_RCLR//
	//REG HIERARCHY: ['REG2_ONREAD_RCLR']//
	//REG ABSOLUTE_ADDR:64'h4//
	//REG OFFSET_ADDR:64'h64'h4//
	logic [31:0] REG2_ONREAD_RCLR_o;
	assign REG2_ONREAD_RCLR_wr_data = wr_sel[1] ? regfile_wr_data : 0;
	assign REG2_ONREAD_RCLR_wr_en = wr_sel[1];
	assign REG2_ONREAD_RCLR_rd_en = rd_sel[1];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG2_ONREAD_RCLR__FIELD_0
		...
		.sw_rd                 (REG2_ONREAD_RCLR_rd_en),
		.sw_wr                 (REG2_ONREAD_RCLR_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG2_ONREAD_RCLR_o[31:0] = 32'h0;
		REG2_ONREAD_RCLR_o[31:0] = REG2_ONREAD_RCLR__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[1] = REG2_ONREAD_RCLR_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG3_ONREAD_RSET//
	//REG HIERARCHY: ['REG3_ONREAD_RSET']//
	//REG ABSOLUTE_ADDR:64'h8//
	//REG OFFSET_ADDR:64'h64'h8//
	logic [31:0] REG3_ONREAD_RSET_o;
	assign REG3_ONREAD_RSET_wr_data = wr_sel[2] ? regfile_wr_data : 0;
	assign REG3_ONREAD_RSET_wr_en = wr_sel[2];
	assign REG3_ONREAD_RSET_rd_en = rd_sel[2];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG3_ONREAD_RSET__FIELD_0
		...
		.sw_rd                 (REG3_ONREAD_RSET_rd_en),
		.sw_wr                 (REG3_ONREAD_RSET_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG3_ONREAD_RSET_o[31:0] = 32'h0;
		REG3_ONREAD_RSET_o[31:0] = REG3_ONREAD_RSET__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[2] = REG3_ONREAD_RSET_o;
