...
(
	...
	,input [1-1:0]REG1_SW_RO__FIELD_0__pulse
	,input [32-1:0]REG2_SW_RW__FIELD_0__next_value
	,input [1-1:0]REG2_SW_RW__FIELD_0__pulse
	,input [32-1:0]REG3_SW_RW1__FIELD_0__next_value
	,input [1-1:0]REG3_SW_RW1__FIELD_0__pulse
	,input [32-1:0]REG4_SW_WO__FIELD_0__next_value
	,input [1-1:0]REG4_SW_WO__FIELD_0__pulse
	,input [32-1:0]REG5_SW_W1__FIELD_0__next_value
	,input [1-1:0]REG5_SW_W1__FIELD_0__pulse
...
regslv_reg_top__reg_block_1 #(.ADDR_WIDTH(`ADDR_WIDTH), .DATA_WIDTH(`DATA_WIDTH))
	...
	,.REG1_SW_RO__FIELD_0__next_value(REG1_SW_RO__FIELD_0__next_value),.REG1_SW_RO__FIELD_0__pulse(REG1_SW_RO__FIELD_0__pulse),.REG2_SW_RW__FIELD_0__next_value(REG2_SW_RW__FIELD_0__next_value)
	,.REG2_SW_RW__FIELD_0__pulse(REG2_SW_RW__FIELD_0__pulse),.REG3_SW_RW1__FIELD_0__next_value(REG3_SW_RW1__FIELD_0__next_value),.REG3_SW_RW1__FIELD_0__pulse(REG3_SW_RW1__FIELD_0__pulse)
	,.REG4_SW_WO__FIELD_0__next_value(REG4_SW_WO__FIELD_0__next_value),.REG4_SW_WO__FIELD_0__pulse(REG4_SW_WO__FIELD_0__pulse),.REG5_SW_W1__FIELD_0__next_value(REG5_SW_W1__FIELD_0__next_value)
	,.REG5_SW_W1__FIELD_0__pulse(REG5_SW_W1__FIELD_0__pulse),.REG1_SW_RO__FIELD_0__curr_value(REG1_SW_RO__FIELD_0__curr_value),.REG2_SW_RW__FIELD_0__curr_value(REG2_SW_RW__FIELD_0__curr_value)
	,.REG3_SW_RW1__FIELD_0__curr_value(REG3_SW_RW1__FIELD_0__curr_value),.REG4_SW_WO__FIELD_0__curr_value(REG4_SW_WO__FIELD_0__curr_value),.REG5_SW_W1__FIELD_0__curr_value(REG5_SW_W1__FIELD_0__curr_value)
