...
logic [31:0] REG1_HW_RO;
assign REG1_HW_RO_wr_data = reg_sel[0] && internal_wr_en ? internal_wr_data : 0;
field
...
always_comb begin
	REG1_HW_RO[31:0] = 32'h0;
	REG1_HW_RO[31:0] = REG1_HW_RO__FIELD_0__curr_value;
end
assign reg_rd_data_in[0] = REG1_HW_RO;
//==========================================END REG INSTANT===========================================//
//============================================REG INSTANT=============================================//
//REG NAME: REG2_HW_RW//
...
logic [31:0] REG2_HW_RW;
assign REG2_HW_RW_wr_data = reg_sel[1] && internal_wr_en ? internal_wr_data : 0;
field
	//**************PARAMETER INSTANTIATE***************//
	#( 
	.F_WIDTH(32),
...
always_comb begin
	REG2_HW_RW[31:0] = 32'h0;
	REG2_HW_RW[31:0] = REG2_HW_RW__FIELD_0__curr_value;
end
assign reg_rd_data_in[1] = REG2_HW_RW;
//==========================================END REG INSTANT===========================================//
//============================================REG INSTANT=============================================//
...
logic [31:0] REG3_HW_CLR;
assign REG3_HW_CLR_wr_data = reg_sel[2] && internal_wr_en ? internal_wr_data : 0;
field
	//**************PARAMETER INSTANTIATE***************//
	#( 
	.F_WIDTH(32),
...
always_comb begin
	REG3_HW_CLR[31:0] = 32'h0;
	REG3_HW_CLR[31:0] = REG3_HW_CLR__FIELD_0__curr_value;
end
assign reg_rd_data_in[2] = REG3_HW_CLR;
//==========================================END REG INSTANT===========================================//
//============================================REG INSTANT=============================================//
...
logic [31:0] REG4_HW_SET;
assign REG4_HW_SET_wr_data = reg_sel[3] && internal_wr_en ? internal_wr_data : 0;
field
	//**************PARAMETER INSTANTIATE***************//
	#( 
	.F_WIDTH(32),
...
always_comb begin
	REG4_HW_SET[31:0] = 32'h0;
	REG4_HW_SET[31:0] = REG4_HW_SET__FIELD_0__curr_value;
end
assign reg_rd_data_in[3] = REG4_HW_SET;
//==========================================END REG INSTANT===========================================//
