...
//*************************************INTERNAL FIELD PORT START**************************************//
	...
	// ports of ['REG1_HW_RO', 'FIELD_0']
	REG1_HW_RO__FIELD_0__next_value        ,
	REG1_HW_RO__FIELD_0__curr_value        ,
	// ports of ['REG2_HW_RW', 'FIELD_0']
	REG2_HW_RW__FIELD_0__next_value        ,
	REG2_HW_RW__FIELD_0__pulse             ,
	REG2_HW_RW__FIELD_0__curr_value        ,
	// ports of ['REG3_HW_CLR', 'FIELD_0']
	REG3_HW_CLR__FIELD_0__next_value        ,
	REG3_HW_CLR__FIELD_0__pulse             ,
	REG3_HW_CLR__FIELD_0__curr_value        ,
	// ports of ['REG4_HW_SET', 'FIELD_0']
	REG4_HW_SET__FIELD_0__next_value        ,
	REG4_HW_SET__FIELD_0__pulse             ,
	REG4_HW_SET__FIELD_0__curr_value        ,
...
//***************************************PORT DECLARATION START***************************************//
	...
	// ports of ['REG1_HW_RO', 'FIELD_0']
	input  [32-1:0]    REG1_HW_RO__FIELD_0__next_value        ;
	output [32-1:0]    REG1_HW_RO__FIELD_0__curr_value        ;
	// ports of ['REG2_HW_RW', 'FIELD_0']
	input  [32-1:0]    REG2_HW_RW__FIELD_0__next_value        ;
	input              REG2_HW_RW__FIELD_0__pulse             ;
	output [32-1:0]    REG2_HW_RW__FIELD_0__curr_value        ;
	// ports of ['REG3_HW_CLR', 'FIELD_0']
	input  [32-1:0]    REG3_HW_CLR__FIELD_0__next_value        ;
	input              REG3_HW_CLR__FIELD_0__pulse             ;
	output [32-1:0]    REG3_HW_CLR__FIELD_0__curr_value        ;
	// ports of ['REG4_HW_SET', 'FIELD_0']
	input  [32-1:0]    REG4_HW_SET__FIELD_0__next_value        ;
	input              REG4_HW_SET__FIELD_0__pulse             ;
	output [32-1:0]    REG4_HW_SET__FIELD_0__curr_value        ;
...
//***************************************WIRE DECLARATION START***************************************//
	...
	logic [31:0] REG1_HW_RO_wr_data;
	logic REG1_HW_RO_wr_en;
	logic REG1_HW_RO_rd_en;
	logic [31:0] REG2_HW_RW_wr_data;
	logic REG2_HW_RW_wr_en;
	logic REG2_HW_RW_rd_en;
	logic [31:0] REG3_HW_CLR_wr_data;
	logic REG3_HW_CLR_wr_en;
	logic REG3_HW_CLR_rd_en;
	logic [31:0] REG4_HW_SET_wr_data;
	logic REG4_HW_SET_wr_en;
	logic REG4_HW_SET_rd_en;
...
//***************************************ADDRESS DECODER START****************************************//
	...
	always_comb begin
		...
		unique casez (regfile_addr)
			64'h0:reg_sel[0] = 1'b1;//['REG1_HW_RO']
			64'h4:reg_sel[1] = 1'b1;//['REG2_HW_RW']
			64'h8:reg_sel[2] = 1'b1;//['REG3_HW_CLR']
			64'hc:reg_sel[3] = 1'b1;//['REG4_HW_SET']
...
//**************************************REG/FIELD INSTANCE START**************************************//
	//============================================REG INSTANT=============================================//
	//REG NAME: REG1_HW_RO//
	//REG HIERARCHY: ['REG1_HW_RO']//
	//REG ABSOLUTE_ADDR:64'h0//
	//REG OFFSET_ADDR:64'h64'h0//
	logic [31:0] REG1_HW_RO_o;
	assign REG1_HW_RO_wr_data = wr_sel[0] ? regfile_wr_data : 0;
	assign REG1_HW_RO_wr_en = wr_sel[0];
	assign REG1_HW_RO_rd_en = rd_sel[0];
	field
	...
	x__REG1_HW_RO__FIELD_0
		//*****************PORT INSTANTIATE*****************//
		(
		.clk                   (regfile_clk),
		.rst_n                 (regfile_rstn),
		.sync_rst              (1'b0),
		.sw_wr_data            (REG1_HW_RO_wr_data[31:0]),
		.sw_rd                 (REG1_HW_RO_rd_en),
		.sw_wr                 (REG1_HW_RO_wr_en),
		...
		.hw_value(32'b0),
		.hw_pulse(1'b0),
		.field_value           (REG1_HW_RO__FIELD_0__curr_value)
		);
	always_comb begin
	REG1_HW_RO_o[31:0] = 32'h0;
		REG1_HW_RO_o[31:0] = REG1_HW_RO__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[0] = REG1_HW_RO_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG2_HW_RW//
	//REG HIERARCHY: ['REG2_HW_RW']//
	//REG ABSOLUTE_ADDR:64'h4//
	//REG OFFSET_ADDR:64'h64'h4//
	logic [31:0] REG2_HW_RW_o;
	assign REG2_HW_RW_wr_data = wr_sel[1] ? regfile_wr_data : 0;
	assign REG2_HW_RW_wr_en = wr_sel[1];
	assign REG2_HW_RW_rd_en = rd_sel[1];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG2_HW_RW__FIELD_0
		//*****************PORT INSTANTIATE*****************//
		(
		.clk                   (regfile_clk),
		.rst_n                 (regfile_rstn),
		.sync_rst              (1'b0),
		.sw_wr_data            (REG2_HW_RW_wr_data[31:0]),
		.sw_rd                 (REG2_HW_RW_rd_en),
		.sw_wr                 (REG2_HW_RW_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
		.hw_value              (REG2_HW_RW__FIELD_0__next_value),
		.hw_pulse              (REG2_HW_RW__FIELD_0__pulse),
		.field_value           (REG2_HW_RW__FIELD_0__curr_value)
		);
	always_comb begin
	REG2_HW_RW_o[31:0] = 32'h0;
		REG2_HW_RW_o[31:0] = REG2_HW_RW__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[1] = REG2_HW_RW_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG3_HW_CLR//
	//REG HIERARCHY: ['REG3_HW_CLR']//
	//REG ABSOLUTE_ADDR:64'h8//
	//REG OFFSET_ADDR:64'h64'h8//
	logic [31:0] REG3_HW_CLR_o;
	assign REG3_HW_CLR_wr_data = wr_sel[2] ? regfile_wr_data : 0;
	assign REG3_HW_CLR_wr_en = wr_sel[2];
	assign REG3_HW_CLR_rd_en = rd_sel[2];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG3_HW_CLR__FIELD_0
		//*****************PORT INSTANTIATE*****************//
		(
		.clk                   (regfile_clk),
		.rst_n                 (regfile_rstn),
		.sync_rst              (1'b0),
		.sw_wr_data            (REG3_HW_CLR_wr_data[31:0]),
		.sw_rd                 (REG3_HW_CLR_rd_en),
		.sw_wr                 (REG3_HW_CLR_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
		.hw_value              (REG3_HW_CLR__FIELD_0__next_value),
		.hw_pulse              (REG3_HW_CLR__FIELD_0__pulse),
		.field_value           (REG3_HW_CLR__FIELD_0__curr_value)
		);
	always_comb begin
	REG3_HW_CLR_o[31:0] = 32'h0;
		REG3_HW_CLR_o[31:0] = REG3_HW_CLR__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[2] = REG3_HW_CLR_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG4_HW_SET//
	//REG HIERARCHY: ['REG4_HW_SET']//
	//REG ABSOLUTE_ADDR:64'hc//
	//REG OFFSET_ADDR:64'h64'hc//
	logic [31:0] REG4_HW_SET_o;
	assign REG4_HW_SET_wr_data = wr_sel[3] ? regfile_wr_data : 0;
	assign REG4_HW_SET_wr_en = wr_sel[3];
	assign REG4_HW_SET_rd_en = rd_sel[3];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG4_HW_SET__FIELD_0
		//*****************PORT INSTANTIATE*****************//
		(
		.clk                   (regfile_clk),
		.rst_n                 (regfile_rstn),
		.sync_rst              (1'b0),
		.sw_wr_data            (REG4_HW_SET_wr_data[31:0]),
		.sw_rd                 (REG4_HW_SET_rd_en),
		.sw_wr                 (REG4_HW_SET_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
		.hw_value              (REG4_HW_SET__FIELD_0__next_value),
		.hw_pulse              (REG4_HW_SET__FIELD_0__pulse),
		.field_value           (REG4_HW_SET__FIELD_0__curr_value)
		);
	always_comb begin
	REG4_HW_SET_o[31:0] = 32'h0;
		REG4_HW_SET_o[31:0] = REG4_HW_SET__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[3] = REG4_HW_SET_o;
