...
(
	...
	,input [1-1:0]REG2_HW_RW__FIELD_0__pulse
	,input [32-1:0]REG3_HW_CLR__FIELD_0__next_value
	,input [1-1:0]REG3_HW_CLR__FIELD_0__pulse
	,input [32-1:0]REG4_HW_SET__FIELD_0__next_value
	,input [1-1:0]REG4_HW_SET__FIELD_0__pulse
...
regslv_reg_top__reg_block_1 #(.ADDR_WIDTH(`ADDR_WIDTH), .DATA_WIDTH(`DATA_WIDTH))
	...
	,.REG2_HW_RW__FIELD_0__next_value(REG2_HW_RW__FIELD_0__next_value),.REG2_HW_RW__FIELD_0__pulse(REG2_HW_RW__FIELD_0__pulse),.REG3_HW_CLR__FIELD_0__next_value(REG3_HW_CLR__FIELD_0__next_value)
	,.REG3_HW_CLR__FIELD_0__pulse(REG3_HW_CLR__FIELD_0__pulse),.REG4_HW_SET__FIELD_0__next_value(REG4_HW_SET__FIELD_0__next_value),.REG4_HW_SET__FIELD_0__pulse(REG4_HW_SET__FIELD_0__pulse)
	,.REG1_HW_RO__FIELD_0__curr_value(REG1_HW_RO__FIELD_0__curr_value),.REG2_HW_RW__FIELD_0__curr_value(REG2_HW_RW__FIELD_0__curr_value),.REG3_HW_CLR__FIELD_0__curr_value(REG3_HW_CLR__FIELD_0__curr_value)
	,.REG4_HW_SET__FIELD_0__curr_value(REG4_HW_SET__FIELD_0__curr_value)
	);
endmodule