...
//***************************************WIRE DECLARATION START***************************************//
	...
	logic REG1_ONWRITE_NA_wr_en;
	logic REG1_ONWRITE_NA_rd_en;
	logic [31:0] REG2_ONWRITE_WOCLR_wr_data;
	logic REG2_ONWRITE_WOCLR_wr_en;
	logic REG2_ONWRITE_WOCLR_rd_en;
	logic [31:0] REG3_ONWRITE_WOSET_wr_data;
	logic REG3_ONWRITE_WOSET_wr_en;
	logic REG3_ONWRITE_WOSET_rd_en;
	logic [31:0] REG4_ONWRITE_WOT_wr_data;
	logic REG4_ONWRITE_WOT_wr_en;
	logic REG4_ONWRITE_WOT_rd_en;
	logic [31:0] REG5_ONWRITE_WZS_wr_data;
	logic REG5_ONWRITE_WZS_wr_en;
	logic REG5_ONWRITE_WZS_rd_en;
	logic [31:0] REG6_ONWRITE_WZC_wr_data;
	logic REG6_ONWRITE_WZC_wr_en;
	logic REG6_ONWRITE_WZC_rd_en;
	logic [31:0] REG7_ONWRITE_WZT_wr_data;
	logic REG7_ONWRITE_WZT_wr_en;
	logic REG7_ONWRITE_WZT_rd_en;
...
//**************************************REG/FIELD INSTANCE START**************************************//
	...
	logic [31:0] REG1_ONWRITE_NA_o;
	assign REG1_ONWRITE_NA_wr_data = wr_sel[0] ? regfile_wr_data : 0;
	assign REG1_ONWRITE_NA_wr_en = wr_sel[0];
	assign REG1_ONWRITE_NA_rd_en = rd_sel[0];
	field
	...
	x__REG1_ONWRITE_NA__FIELD_0
		...
		.sw_rd                 (REG1_ONWRITE_NA_rd_en),
		.sw_wr                 (REG1_ONWRITE_NA_wr_en),
	...
	always_comb begin
	REG1_ONWRITE_NA_o[31:0] = 32'h0;
		REG1_ONWRITE_NA_o[31:0] = REG1_ONWRITE_NA__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[0] = REG1_ONWRITE_NA_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG2_ONWRITE_WOCLR//
	//REG HIERARCHY: ['REG2_ONWRITE_WOCLR']//
	//REG ABSOLUTE_ADDR:64'h4//
	//REG OFFSET_ADDR:64'h64'h4//
	logic [31:0] REG2_ONWRITE_WOCLR_o;
	assign REG2_ONWRITE_WOCLR_wr_data = wr_sel[1] ? regfile_wr_data : 0;
	assign REG2_ONWRITE_WOCLR_wr_en = wr_sel[1];
	assign REG2_ONWRITE_WOCLR_rd_en = rd_sel[1];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG2_ONWRITE_WOCLR__FIELD_0
		...
		.sw_rd                 (REG2_ONWRITE_WOCLR_rd_en),
		.sw_wr                 (REG2_ONWRITE_WOCLR_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG2_ONWRITE_WOCLR_o[31:0] = 32'h0;
		REG2_ONWRITE_WOCLR_o[31:0] = REG2_ONWRITE_WOCLR__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[1] = REG2_ONWRITE_WOCLR_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG3_ONWRITE_WOSET//
	//REG HIERARCHY: ['REG3_ONWRITE_WOSET']//
	//REG ABSOLUTE_ADDR:64'h8//
	//REG OFFSET_ADDR:64'h64'h8//
	logic [31:0] REG3_ONWRITE_WOSET_o;
	assign REG3_ONWRITE_WOSET_wr_data = wr_sel[2] ? regfile_wr_data : 0;
	assign REG3_ONWRITE_WOSET_wr_en = wr_sel[2];
	assign REG3_ONWRITE_WOSET_rd_en = rd_sel[2];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG3_ONWRITE_WOSET__FIELD_0
		...
		.sw_rd                 (REG3_ONWRITE_WOSET_rd_en),
		.sw_wr                 (REG3_ONWRITE_WOSET_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG3_ONWRITE_WOSET_o[31:0] = 32'h0;
		REG3_ONWRITE_WOSET_o[31:0] = REG3_ONWRITE_WOSET__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[2] = REG3_ONWRITE_WOSET_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG4_ONWRITE_WOT//
	//REG HIERARCHY: ['REG4_ONWRITE_WOT']//
	//REG ABSOLUTE_ADDR:64'hc//
	//REG OFFSET_ADDR:64'h64'hc//
	logic [31:0] REG4_ONWRITE_WOT_o;
	assign REG4_ONWRITE_WOT_wr_data = wr_sel[3] ? regfile_wr_data : 0;
	assign REG4_ONWRITE_WOT_wr_en = wr_sel[3];
	assign REG4_ONWRITE_WOT_rd_en = rd_sel[3];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG4_ONWRITE_WOT__FIELD_0
		...
		.sw_rd                 (REG4_ONWRITE_WOT_rd_en),
		.sw_wr                 (REG4_ONWRITE_WOT_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG4_ONWRITE_WOT_o[31:0] = 32'h0;
		REG4_ONWRITE_WOT_o[31:0] = REG4_ONWRITE_WOT__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[3] = REG4_ONWRITE_WOT_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG5_ONWRITE_WZS//
	//REG HIERARCHY: ['REG5_ONWRITE_WZS']//
	//REG ABSOLUTE_ADDR:64'h10//
	//REG OFFSET_ADDR:64'h64'h10//
	logic [31:0] REG5_ONWRITE_WZS_o;
	assign REG5_ONWRITE_WZS_wr_data = wr_sel[4] ? regfile_wr_data : 0;
	assign REG5_ONWRITE_WZS_wr_en = wr_sel[4];
	assign REG5_ONWRITE_WZS_rd_en = rd_sel[4];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG5_ONWRITE_WZS__FIELD_0
		...
		.sw_rd                 (REG5_ONWRITE_WZS_rd_en),
		.sw_wr                 (REG5_ONWRITE_WZS_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG5_ONWRITE_WZS_o[31:0] = 32'h0;
		REG5_ONWRITE_WZS_o[31:0] = REG5_ONWRITE_WZS__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[4] = REG5_ONWRITE_WZS_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG6_ONWRITE_WZC//
	//REG HIERARCHY: ['REG6_ONWRITE_WZC']//
	//REG ABSOLUTE_ADDR:64'h14//
	//REG OFFSET_ADDR:64'h64'h14//
	logic [31:0] REG6_ONWRITE_WZC_o;
	assign REG6_ONWRITE_WZC_wr_data = wr_sel[5] ? regfile_wr_data : 0;
	assign REG6_ONWRITE_WZC_wr_en = wr_sel[5];
	assign REG6_ONWRITE_WZC_rd_en = rd_sel[5];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG6_ONWRITE_WZC__FIELD_0
		...
		.sw_rd                 (REG6_ONWRITE_WZC_rd_en),
		.sw_wr                 (REG6_ONWRITE_WZC_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG6_ONWRITE_WZC_o[31:0] = 32'h0;
		REG6_ONWRITE_WZC_o[31:0] = REG6_ONWRITE_WZC__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[5] = REG6_ONWRITE_WZC_o;
	//============================================REG INSTANT=============================================//
	//REG NAME: REG7_ONWRITE_WZT//
	//REG HIERARCHY: ['REG7_ONWRITE_WZT']//
	//REG ABSOLUTE_ADDR:64'h18//
	//REG OFFSET_ADDR:64'h64'h18//
	logic [31:0] REG7_ONWRITE_WZT_o;
	assign REG7_ONWRITE_WZT_wr_data = wr_sel[6] ? regfile_wr_data : 0;
	assign REG7_ONWRITE_WZT_wr_en = wr_sel[6];
	assign REG7_ONWRITE_WZT_rd_en = rd_sel[6];
	field
		//**************PARAMETER INSTANTIATE***************//
		#(
		.F_WIDTH               (32),
	...
	x__REG7_ONWRITE_WZT__FIELD_0
		...
		.sw_rd                 (REG7_ONWRITE_WZT_rd_en),
		.sw_wr                 (REG7_ONWRITE_WZT_wr_en),
		.write_protect_en      (1'b0),
		.sw_type_alter_signal  (1'b0),
		.swmod_out(),
		.swacc_out(),
	...
	always_comb begin
	REG7_ONWRITE_WZT_o[31:0] = 32'h0;
		REG7_ONWRITE_WZT_o[31:0] = REG7_ONWRITE_WZT__FIELD_0__curr_value;
	end
	assign regfile_reg_rd_data_in[6] = REG7_ONWRITE_WZT_o;
