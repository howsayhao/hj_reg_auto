...
logic [31:0] REG2;
assign REG2_wr_data = reg_sel[1] && internal_wr_en ? internal_wr_data : 0;
field
	//**************PARAMETER INSTANTIATE***************//
	#( 
	.F_WIDTH(32),
...
always_comb begin
	REG2[31:0] = 32'h0;
	REG2[31:0] = REG2__FIELD_0__curr_value;
end
assign reg_rd_data_in[1] = REG2;
//==========================================END REG INSTANT===========================================//
//============================================REG INSTANT=============================================//
//REG NAME: REG3//
//REG HIERARCHY: ['REG3']//
...
logic [31:0] REG3;
assign REG3_wr_data = reg_sel[2] && internal_wr_en ? internal_wr_data : 0;
field
	//**************PARAMETER INSTANTIATE***************//
	#( 
	.F_WIDTH(32),
...
always_comb begin
	REG3[31:0] = 32'h0;
	REG3[31:0] = REG3__FIELD_0__curr_value;
end
assign reg_rd_data_in[2] = REG3;
//==========================================END REG INSTANT===========================================//
//============================================REG INSTANT=============================================//
//REG NAME: REG4//
//REG HIERARCHY: ['REG4']//
...
logic [31:0] REG4;
assign REG4_wr_data = reg_sel[3] && internal_wr_en ? internal_wr_data : 0;
field
	//**************PARAMETER INSTANTIATE***************//
	#( 
	.F_WIDTH(32),
...
always_comb begin
	REG4[31:0] = 32'h0;
	REG4[31:0] = REG4__FIELD_0__curr_value;
end
assign reg_rd_data_in[3] = REG4;
//==========================================END REG INSTANT===========================================//
