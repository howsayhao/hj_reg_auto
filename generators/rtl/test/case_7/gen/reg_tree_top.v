...
regslv_reg_top__reg_block_1 #(.ADDR_WIDTH(`ADDR_WIDTH), .DATA_WIDTH(`DATA_WIDTH))
	...
	,.REG5_SWACC__FIELD_0__curr_value(REG5_SWACC__FIELD_0__curr_value),.REG6_PRECEDENCE_SW__FIELD_0__curr_value(REG6_PRECEDENCE_SW__FIELD_0__curr_value),.REG7_PRECEDENCE_HW__FIELD_0__curr_value(REG7_PRECEDENCE_HW__FIELD_0__curr_value)
