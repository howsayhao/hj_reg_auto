...
(
	...
	,input [1-1:0]REG1_SRST__FIELD_0__pulse
	,input [32-1:0]REG2_SRST__FIELD_0__next_value
	,input [1-1:0]REG2_SRST__FIELD_0__pulse
	,input [32-1:0]REG3_SRST__FIELD_0__next_value
	,input [1-1:0]REG3_SRST__FIELD_0__pulse
	,input [32-1:0]REG4_SWMOD__FIELD_0__next_value
	,input [1-1:0]REG4_SWMOD__FIELD_0__pulse
	,input [32-1:0]REG5_SWACC__FIELD_0__next_value
	,input [1-1:0]REG5_SWACC__FIELD_0__pulse
	,input [32-1:0]REG6_PRECEDENCE_SW__FIELD_0__next_value
	,input [1-1:0]REG6_PRECEDENCE_SW__FIELD_0__pulse
	,input [32-1:0]REG7_PRECEDENCE_HW__FIELD_0__next_value
	,input [1-1:0]REG7_PRECEDENCE_HW__FIELD_0__pulse
	...
	,output [1-1:0]REG4_SWMOD__FIELD_0__swmod_out
	,output [32-1:0]REG5_SWACC__FIELD_0__curr_value
	,output [1-1:0]REG5_SWACC__FIELD_0__swacc_out
...
logic regslv_reg_top__reg_block_1__wr_en;
logic regslv_reg_top__reg_block_1__rd_en;
logic regslv_reg_top__reg_block_1_fsm_sync_reset;
logic [`DATA_WIDTH-1:0]regslv_reg_top__reg_block_1__wr_data;
logic [`ADDR_WIDTH-1:0] regslv_reg_top__reg_block_1__addr;
...
regslv_reg_top__reg_block_1 #(.ADDR_WIDTH(`ADDR_WIDTH), .DATA_WIDTH(`DATA_WIDTH))
	...
	,.ext_wr_en(regslv_reg_top__reg_block_1__wr_en),.ext_rd_en(regslv_reg_top__reg_block_1__rd_en),.ext_wr_data(regslv_reg_top__reg_block_1__wr_data),.ext_addr(regslv_reg_top__reg_block_1__addr),.cdc_pulse_out(regslv_reg_top__reg_block_1_cdc_pulse_out)
	...
	,.REG1_SRST__FIELD_0__next_value(REG1_SRST__FIELD_0__next_value),.REG1_SRST__FIELD_0__pulse(REG1_SRST__FIELD_0__pulse),.REG2_SRST__FIELD_0__next_value(REG2_SRST__FIELD_0__next_value)
	,.REG2_SRST__FIELD_0__pulse(REG2_SRST__FIELD_0__pulse),.REG3_SRST__FIELD_0__next_value(REG3_SRST__FIELD_0__next_value),.REG3_SRST__FIELD_0__pulse(REG3_SRST__FIELD_0__pulse)
	,.REG4_SWMOD__FIELD_0__next_value(REG4_SWMOD__FIELD_0__next_value),.REG4_SWMOD__FIELD_0__pulse(REG4_SWMOD__FIELD_0__pulse),.REG5_SWACC__FIELD_0__next_value(REG5_SWACC__FIELD_0__next_value)
	,.REG5_SWACC__FIELD_0__pulse(REG5_SWACC__FIELD_0__pulse),.REG6_PRECEDENCE_SW__FIELD_0__next_value(REG6_PRECEDENCE_SW__FIELD_0__next_value),.REG6_PRECEDENCE_SW__FIELD_0__pulse(REG6_PRECEDENCE_SW__FIELD_0__pulse)
	,.REG7_PRECEDENCE_HW__FIELD_0__next_value(REG7_PRECEDENCE_HW__FIELD_0__next_value),.REG7_PRECEDENCE_HW__FIELD_0__pulse(REG7_PRECEDENCE_HW__FIELD_0__pulse),.REG1_SRST__FIELD_0__curr_value(REG1_SRST__FIELD_0__curr_value)
	,.REG2_SRST__FIELD_0__curr_value(REG2_SRST__FIELD_0__curr_value),.REG3_SRST__FIELD_0__curr_value(REG3_SRST__FIELD_0__curr_value),.REG4_SWMOD__FIELD_0__curr_value(REG4_SWMOD__FIELD_0__curr_value)
	,.REG4_SWMOD__FIELD_0__swmod_out(REG4_SWMOD__FIELD_0__swmod_out),.REG5_SWACC__FIELD_0__curr_value(REG5_SWACC__FIELD_0__curr_value),.REG5_SWACC__FIELD_0__swacc_out(REG5_SWACC__FIELD_0__swacc_out)
	,.REG6_PRECEDENCE_SW__FIELD_0__curr_value(REG6_PRECEDENCE_SW__FIELD_0__curr_value),.REG7_PRECEDENCE_HW__FIELD_0__curr_value(REG7_PRECEDENCE_HW__FIELD_0__curr_value)
	);
endmodule