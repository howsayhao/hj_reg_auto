`ifndef __regmst_test_vh__
`define __regmst_test_vh__
//**************************************Address Definition Here***************************************//
`define regslv_test_inst_test_1_inst_REG1_SW_RW 64'h0//external
`define regslv_test_inst_test_1_inst_REG2_SW_W 64'h4//external
`define regslv_test_inst_test_1_inst_REG3_HW 64'h8//external
`define regslv_test_inst_test_1_inst_REG4_PRECEDENCE 64'hc//external
`define regslv_test_inst_test_1_inst_REG5_SINGLEPULSE 64'h10//external
`define regslv_test_inst_test_1_inst_REG6_SW_ACC_MOD 64'h14//external
`define regslv_test_inst_test_1_inst_REG1_SW_R_alias 64'h100//external
`define regslv_test_inst_test_1_inst_REG2_SRST_alias 64'h104//external
`define regslv_test_inst_test_2_inst_shared_2 64'h108//external
`define regslv_test_inst_test_3_inst_shared_3 64'h10c//external
