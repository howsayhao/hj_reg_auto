...
package root_map;
    ...
    class root_map__test_map_1_inst__TEM21 extends uvm_reg;
        `uvm_object_utils(root_map__test_map_1_inst__TEM21)
        ...
        virtual function void build();
            this.FIELD_3 = uvm_reg_field::type_id::create("FIELD_3");
            this.FIELD_3.configure(this, 1, 13, "W1T", 1, 'h1, 1, 1, 0);
            this.FIELD_2 = uvm_reg_field::type_id::create("FIELD_2");
            this.FIELD_2.configure(this, 3, 14, "W1S", 1, 'h0, 1, 1, 0);
            this.FIELD_1 = uvm_reg_field::type_id::create("FIELD_1");
    ...
    class root_map__test_map_1_inst__TEM22 extends uvm_reg;
        `uvm_object_utils(root_map__test_map_1_inst__TEM22)
        rand uvm_reg_field FIELD_3;
        rand uvm_reg_field FIELD_2;
        rand uvm_reg_field FIELD_1;
    ...
    class root_map__test_map_1_inst__TEM23 extends uvm_reg;
        `uvm_object_utils(root_map__test_map_1_inst__TEM23)
        rand uvm_reg_field FIELD_3;
        rand uvm_reg_field FIELD_2;
        rand uvm_reg_field FIELD_1;
    ...
    class root_map__test_map_1_inst__TEM21_alias extends uvm_reg;
        `uvm_object_utils(root_map__test_map_1_inst__TEM21_alias)
        rand uvm_reg_field FIELD_3;
        rand uvm_reg_field FIELD_2;
        rand uvm_reg_field FIELD_1;
    ...
    class root_map__test_map_1_inst__TEM22_alias extends uvm_reg;
        `uvm_object_utils(root_map__test_map_1_inst__TEM22_alias)
        rand uvm_reg_field FIELD_3;
        rand uvm_reg_field FIELD_2;
        rand uvm_reg_field FIELD_1;
    ...
    class root_map__test_map_1_inst__TEM23_alias extends uvm_reg;
        `uvm_object_utils(root_map__test_map_1_inst__TEM23_alias)
        rand uvm_reg_field FIELD_3;
        rand uvm_reg_field FIELD_2;
        rand uvm_reg_field FIELD_1;
    ...
    class root_map__test_map_1_inst extends uvm_reg_block;
        `uvm_object_utils(root_map__test_map_1_inst)
        ...
        virtual function void build();
            ...
            this.TEM21 = root_map__test_map_1_inst__TEM21::type_id::create("TEM21");
            ...
            this.TEM22 = root_map__test_map_1_inst__TEM22::type_id::create("TEM22");
            ...
            this.TEM23 = root_map__test_map_1_inst__TEM23::type_id::create("TEM23");
            ...
            this.TEM21_alias = root_map__test_map_1_inst__TEM21_alias::type_id::create("TEM21_alias");
            ...
            this.TEM22_alias = root_map__test_map_1_inst__TEM22_alias::type_id::create("TEM22_alias");
            ...
            this.TEM23_alias = root_map__test_map_1_inst__TEM23_alias::type_id::create("TEM23_alias");
    ...
    class root_map__test_map_2_inst__shared_2 extends uvm_reg;
        `uvm_object_utils(root_map__test_map_2_inst__shared_2)
        rand uvm_reg_field FIELD_2;
        rand uvm_reg_field FIELD_1;
    ...
    class root_map__test_map_2_inst extends uvm_reg_block;
        `uvm_object_utils(root_map__test_map_2_inst)
        ...
        virtual function void build();
            this.default_map = create_map("reg_map", 0, 4, UVM_NO_ENDIAN);
            this.shared_2 = root_map__test_map_2_inst__shared_2::type_id::create("shared_2");
    ...
    class root_map__test_map_3_inst__shared_3 extends uvm_reg;
        `uvm_object_utils(root_map__test_map_3_inst__shared_3)
        rand uvm_reg_field FIELD_2;
        rand uvm_reg_field FIELD_1;
    ...
    class root_map__test_map_3_inst extends uvm_reg_block;
        `uvm_object_utils(root_map__test_map_3_inst)
        ...
        virtual function void build();
            this.default_map = create_map("reg_map", 0, 4, UVM_NO_ENDIAN);
            this.shared_3 = root_map__test_map_3_inst__shared_3::type_id::create("shared_3");
    ...
    class root_map__ipxact_block_example_inst__reg1 extends uvm_reg;
        `uvm_object_utils(root_map__ipxact_block_example_inst__reg1)
    ...
    class root_map__ipxact_block_example_inst__reg_array extends uvm_reg;
        `uvm_object_utils(root_map__ipxact_block_example_inst__reg_array)
        ...
        virtual function void build();
            this.x = uvm_reg_field::type_id::create("x");
    ...
    class root_map__ipxact_block_example_inst extends uvm_reg_block;
        `uvm_object_utils(root_map__ipxact_block_example_inst)
        ...
        virtual function void build();
            this.default_map = create_map("reg_map", 0, 4, UVM_NO_ENDIAN);
            this.reg1 = root_map__ipxact_block_example_inst__reg1::type_id::create("reg1");
            this.reg1.configure(this);

            this.reg1.build();
            this.default_map.add_reg(this.reg1, 'h0);
            foreach(this.reg_array[i0]) begin
                this.reg_array[i0] = root_map__ipxact_block_example_inst__reg_array::type_id::create($sformatf("reg_array[%0d]", i0));
    ...
    class root_map extends uvm_reg_block;
        ...
        virtual function void build();
            this.default_map = create_map("reg_map", 0, 4, UVM_NO_ENDIAN);
            this.test_map_1_inst = root_map__test_map_1_inst::type_id::create("test_map_1_inst");
            ...
            this.test_map_2_inst = root_map__test_map_2_inst::type_id::create("test_map_2_inst");
            ...
            this.test_map_3_inst = root_map__test_map_3_inst::type_id::create("test_map_3_inst");
            ...
            this.ipxact_block_example_inst = root_map__ipxact_block_example_inst::type_id::create("ipxact_block_example_inst");
